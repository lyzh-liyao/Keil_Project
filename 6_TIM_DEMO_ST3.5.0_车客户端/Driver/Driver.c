...
void  USART1_SendString(char* SendData,u8 length)
{
	u8 i=0;
	for(;i<length;i++){
...
********************************************************************************************************/
char printString[1]={""};
void asyncPrint(char* str){
	strcat(printString, str);
	//printf(printString);
	//USART1_SendData(0x12);
	//USART1_SendData(printString[0]);
	//USART1_SendData(0x34);
	//USART1_SendData(printString[1]);
}
