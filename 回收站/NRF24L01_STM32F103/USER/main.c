...
u8 TxBuf[32]={0};//{0x08,0xEF,0x03,0x04,0x05,0x06,0x07,0x08};
...
{	
	...
	//------------测试----------------------
	taskid = TimeTask_Add(4, Create_SysTickStamp(0, 100, 0), test,Real_Time_Mode);
	printf("test\r\n");
	while(1){
		TimeTask_Run();	
		//printf("count:%d\r\n",SysTick->VAL);
