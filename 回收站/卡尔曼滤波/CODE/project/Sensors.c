...
{	
	...
	Motor3.CurrentLast = Motor3.Current;
	Motor4.CurrentLast = Motor4.Current;
	Motor5.CurrentLast = Motor5.Current;
	
	Motor1.Current = cal_ADC_value[ADC_L_CHANNEL];
	Motor2.Current = cal_ADC_value[ADC_R_CHANNEL];
	Motor3.Current = cal_ADC_value[ADC_H_CHANNEL];// 
	Motor3.angle = 10 * cal_ADC_value[ADC_H_Angle_CHANNEL];
	Motor4.Current = cal_ADC_value[ADC_W_CHANNEL];
	Motor5.Current = cal_ADC_value[ADC_W_CHANNEL];
...
void ReadFuse(void)
{
	...
	Motor3.fuseSensor = !GET_FUSE_SEN_HW;
}
