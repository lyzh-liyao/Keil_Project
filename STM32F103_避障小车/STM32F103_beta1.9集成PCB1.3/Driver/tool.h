...
#define EXTI_IT_DISABLE() __set_PRIMASK(1)	//关闭总中断
#define EXTI_IT_ENABLE() __set_PRIMASK(0)		//开启总中断
...
#define DELAYUS(us) do{DelayCount = 3 * us;while(DelayCount--);}while(0)
/****************************************************
	结构体名:	SysTickStamp_t
	功能:	时间戳实体
