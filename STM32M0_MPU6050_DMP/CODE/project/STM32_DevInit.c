...
void ADC_Configuration(void)
{
	...
	ADC_ChannelConfig(ADC1, ADC_Channel_0 , ADC_SampleTime_55_5Cycles); //ADC_L 左电机过流	PA0
	ADC_ChannelConfig(ADC1, ADC_Channel_1 , ADC_SampleTime_55_5Cycles); //ADC_R 右电机过流	PA1
	ADC_ChannelConfig(ADC1, ADC_Channel_5 , ADC_SampleTime_55_5Cycles); //ADC_H	头部电机过流 PA5
	ADC_ChannelConfig(ADC1, ADC_Channel_8 , ADC_SampleTime_55_5Cycles); //ADC_W	翅膀电机过流PB0
	ADC_ChannelConfig(ADC1, ADC_Channel_9 , ADC_SampleTime_55_5Cycles); //ADC_Angle_H 头部电机角度 PB1
	/* ADC Calibration */
...
void DMA_Configuration(void)
{
	...
	DMA_InitStructure.DMA_BufferSize = ADC_SAMPLING_NUM * ADC_CHANNEL_NUM;
...
{	
	...
	/*EXTI_InitStructure.EXTI_Line = EXTI_Line9|EXTI_Line11|EXTI_Line15;
	EXTI_InitStructure.EXTI_Mode = EXTI_Mode_Interrupt;
	EXTI_InitStructure.EXTI_Trigger = EXTI_Trigger_Rising_Falling;
	EXTI_InitStructure.EXTI_LineCmd = ENABLE;
	EXTI_Init(&EXTI_InitStructure);
	SYSCFG_EXTILineConfig(EXTI_PortSourceGPIOA, EXTI_PinSource9|EXTI_PinSource11|EXTI_PinSource15);
	
	EXTI_InitStructure.EXTI_Line = EXTI_Line4|EXTI_Line5|EXTI_Line8|EXTI_Line9|EXTI_Line15;
	EXTI_InitStructure.EXTI_Mode = EXTI_Mode_Interrupt;
	EXTI_InitStructure.EXTI_Trigger = EXTI_Trigger_Rising_Falling;
	EXTI_InitStructure.EXTI_LineCmd = ENABLE;
	EXTI_Init(&EXTI_InitStructure);
	SYSCFG_EXTILineConfig(EXTI_PortSourceGPIOA, EXTI_PinSource4|EXTI_PinSource5|EXTI_PinSource8|EXTI_PinSource9|EXTI_PinSource15);
	*/
...
// 在开发板上用来驱动LED的，在驱动板上不用			IO
	...
	//DIR OUT  PA8:DIR_1 PB3:DIR_2 PB2:DIR_3	PB10:DIR_4 PB11/DIR_5	IO
	...
	//liyao 2015年9月6日13:42:06
	//LIMIT		IN	 PB15:W_IO_L PA15:W_IO_R PB8:H_IO_L PB9:H_IO_R
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_15|GPIO_Pin_8|GPIO_Pin_9;                 
	...
	//liyao 2015年9月6日13:42:06
	//ENCODER  IN PA9:EN1A PA10:EN1B PA11:EN2A PA12:EN2B PB5:ENC_W_R PB4:ENC_W_L 		IO
...
/*//I2C1  			 				PB8/9					AF
	...
	//liyao 2015年9月6日13:42:06	
	//ADC  			PA0:ADC_L  PA1:ADC_R	PA5:ADC_H	PB0:ADC_W PB1/ADC_Angle_H
