...
extern void BaseClock_Init1(void);
...
extern void DelayUS1(uint32_t);
extern void DelayMS1(uint32_t);
extern void DelayS1(int);
...
extern int8_t TimeTask_Add(int8_t title,SysTickStamp_t interval,void(*_task_handle)(void),TASK_MODE taskmode);
