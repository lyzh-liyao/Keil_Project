...
void respond_protocol_send(PROTOCOL_INFO_T* pi){
	...
	PROTOCOL_INFO_T proto_info = Create_Protocol_Info(sizeof(RESPOND_PROTOCOL_T),RESPOND_PROTOCOL,NULL,NULL);
	RESPOND_PROTOCOL_T* rp = &proto_info.protocol.respond_protocol;
	rp->head = 0xFD;
